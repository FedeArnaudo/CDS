    ...
    internal class ConectorSQLite
    {
        ...
        public static DataTable Dt_query(string query)
        {
            ...
            using (SQLiteConnection db = new SQLiteConnection(
                string.Format(connectionString, Configuration.LeerConfiguracion().RutaProyNuevo + "\\CDS\\" + databaseName)))
            {
                db.Open();
        ...
        public static bool ComprobarCierre()
        {
            ...
            using (SQLiteConnection db = new SQLiteConnection(string.Format(connectionString, Configuration.LeerConfiguracion().RutaProyNuevo + "\\CDS\\" + databaseName)))
            {
                db.Open();
                using (SQLiteCommand command = new SQLiteCommand(query, db))
                {
        ...
        {
            string folderPath = Configuration.LeerConfiguracion().RutaProyNuevo + "\\CDS";
